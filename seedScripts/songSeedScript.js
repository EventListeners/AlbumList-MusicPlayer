...
console.log(`new file created: songs_data${fileNameCounterSong}.csv`);
    ...
    for (let j = 1; j <= numberAlbums; j++) {
        ...
        for (let k = 1; k <= numberSongs; k++) {
            ...
            if(songsCounter % 1000000 === 0){
                ...
                // if(songsCounter % 30000000 === 0) {
                //     fileNameCounterSong++;
                //     streamSongs.end(() => console.log('songs file created ' + fileNameCounterSong));
